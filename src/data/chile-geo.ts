/** Regiones de Chile ordenadas de norte a sur, con Metropolitana primero */
export const REGIONES_CHILE: { nombre: string; comunas: string[] }[] = [
  {
    ...
    comunas: [
      ...
      "San Miguel","San Ramón","Santiago","Vitacura","Buin","Calera de Tango","Colina","Curacaví",
      "El Monte","Isla de Maipo","Lampa","María Pinto","Melipilla","Padre Hurtado","Paine",
      "Peñaflor","Pirque","Puente Alto","San José de Maipo","San Pedro","Talagante","Tiltil"
    ],
  },
  {
