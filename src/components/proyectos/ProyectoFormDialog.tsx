...
export default function ProyectoFormDialog({ open, onOpenChange, onSubmit, isLoading, initialData, mode }: Props) {
  ...
  const buildSnapshot = () =>
    JSON.stringify({
      nombre, region, direccion, comuna, estadoObra, fechaEstadoObra, estadoAmc, notas, empresaSelection,
        ...
        <DialogContent className="max-w-2xl max-h-[85vh] p-0">
          ...
          <ScrollArea className="max-h-[70vh] px-6 pb-6">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {/* Estado Obra / Fecha / Estado AMC – always visible */}
              ...
              {/* Empresa y cotización – always visible */}
